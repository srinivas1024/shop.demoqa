...
public class Hooks {
	...
	/*
	 * We have not started our driver in the @Before method, because we have
	 * been doing the same in the TestContext class constructor. Because our
	...
	/*
	 * @After(Order = 1) will run before the @After(Order = 0), as screenshot
	 * needs the driver object. So driver should be closed after taking
	 * screenshot.
	 */
